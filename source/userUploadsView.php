...
if(isset($_GET['content_id']) && isset($_GET['media_type'])) {
	...
	if(isset($othersprofile)) {
		$uploadssearch = sprintf("SELECT CONTENT_ID,
								  	CONTENT_TITLE,
								 	CONTENT_LOCATION
	...
	$uploadssearchquery = mysql_query($uploadssearch) or die('Failed to search uploads');
	while($uploadssearchresults = mysql_fetch_array($uploadssearchquery)) {
	...
	<!-- 				<input type="submit" name="download" value="Download"/> -->
			...
			if(isset($_POST['change'])) {
				...
				if($privacy == 0) {
					...
					$updateprivacyquery = "UPDATE MT_CONTENT SET CONTENT_SHARING = '$filePrivacy'
									  	   WHERE CONTENT_ID = '$contentid'";
					$updateprivacy = mysql_query($updateprivacyquery);
					$updateprivacyid = mysql_insert_id();
